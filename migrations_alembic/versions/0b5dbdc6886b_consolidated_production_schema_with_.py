...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("TRAVELER", "CONTRIBUTOR", "MODERATOR", "ADMIN", name="userrole"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_user_events_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_user_events")),
    )
    op.create_index(
        op.f("ix_user_events_event_type"), "user_events", ["event_type"], unique=False
    )
    op.create_table(
        "districts",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["district_id"],
            ["districts.id"],
            name=op.f("fk_cities_district_id_districts"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["city_id"], ["cities.id"], name=op.f("fk_villages_city_id_cities")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["category_id"],
            ["categories.id"],
            name=op.f("fk_places_category_id_categories"),
        ),
        sa.ForeignKeyConstraint(
            ["city_id"], ["cities.id"], name=op.f("fk_places_city_id_cities")
        ),
        sa.ForeignKeyConstraint(
            ["state_id"], ["states.id"], name=op.f("fk_places_state_id_states")
        ),
        sa.ForeignKeyConstraint(
            ["subcategory_id"],
            ["subcategories.id"],
            name=op.f("fk_places_subcategory_id_subcategories"),
        ),
        sa.ForeignKeyConstraint(
            ["village_id"], ["villages.id"], name=op.f("fk_places_village_id_villages")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_places")),
    )
    op.create_index(
        op.f("ix_places_category_id"), "places", ["category_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_places_subcategory_id"), "places", ["subcategory_id"], unique=False
    )
    op.create_index(
        op.f("ix_places_village_id"), "places", ["village_id"], unique=False
    )
    op.create_table(
        "bookmarks",
        sa.Column("id", sa.String(length=36), nullable=False),
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["place_id"], ["places.id"], name=op.f("fk_bookmarks_place_id_places")
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["users.id"], name=op.f("fk_bookmarks_user_id_users")
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_bookmarks")),
    )
    op.create_index(
        op.f("ix_bookmarks_place_id"), "bookmarks", ["place_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["place_id"],
            ["places.id"],
            name=op.f("fk_intelligence_scores_place_id_places"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_intelligence_scores")),
    )
    op.create_index(
        op.f("ix_intelligence_scores_place_id"),
        "intelligence_scores",
        ["place_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["source_id"],
            ["places.id"],
            name=op.f("fk_node_relationships_source_id_places"),
        ),
        sa.ForeignKeyConstraint(
            ["target_id"],
            ["places.id"],
            name=op.f("fk_node_relationships_target_id_places"),
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_node_relationships")),
    )
    op.create_index(
        op.f("ix_node_relationships_source_id"),
        "node_relationships",
        ["source_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_node_relationships_target_id"),
        "node_relationships",
        ["target_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["activity_id"],
            ["activities.id"],
            name=op.f("fk_place_activities_activity_id_activities"),
        ),
        sa.ForeignKeyConstraint(
            ["place_id"],
            ["places.id"],
            name=op.f("fk_place_activities_place_id_places"),
        ),
        sa.PrimaryKeyConstraint(
            "place_id", "activity_id", name=op.f("pk_place_activities")
        ),
    )
    op.create_table(
        "place_images",
        ...
        sa.ForeignKeyConstraint(
            ["place_id"], ["places.id"], name=op.f("fk_place_images_place_id_places")
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["place_id"], ["places.id"], name=op.f("fk_place_tags_place_id_places")
        ),
        sa.ForeignKeyConstraint(
            ["tag_id"], ["tags.id"], name=op.f("fk_place_tags_tag_id_tags")
        ),
    ...
    op.create_table(
        ...
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(
            ["place_id"], ["places.id"], name=op.f("fk_reviews_place_id_places")
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.Column("place_id", sa.String(length=36), nullable=False),
        sa.ForeignKeyConstraint(
            ["place_id"], ["places.id"], name=op.f("fk_user_favorites_place_id_places")
        ),
        sa.ForeignKeyConstraint(
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_node_relationships_target_id"), table_name="node_relationships"
    )
    op.drop_index(
        op.f("ix_node_relationships_source_id"), table_name="node_relationships"
    )
    op.drop_table("node_relationships")
    op.drop_index(
        op.f("ix_intelligence_scores_place_id"), table_name="intelligence_scores"
    )
